<script type="text/html" data-help-name="change-attribute">

</script>

<script type="text/html" data-template-name="change-attribute">
...
<script type="text/javascript">
  RED.nodes.registerType('change-attribute', {
    category: 'core',
    color: '#E2D96E',
    defaults: { 
      name: { value: "" },
    ...
    icon: "file.png",
    label: function () {
      return this.name || "change-attribute";
    },
    paletteLabel: 'change-attribute',
